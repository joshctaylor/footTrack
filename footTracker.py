...
videoFile = 'E:/A8D04_AFT.mp4'
outputVid = 'E:/A8D04_AFT_out.mp4'
buffer = 32

fileName = videoFile + '.csv'
...
if camera.isOpened():
    ...
    fps = camera.get(5)
    outputVideo = cv2.VideoWriter(videoFile, fourcc, fps, (width, height))
    ...
    # only proceed if at least one contour was found
    	...
    	fileWriter.writerow([counter, center[0], center[1]])
